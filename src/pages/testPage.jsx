    ...
    return(
        <div className="w-full h-screen flex flex-col justify-center items-center" >
            <div className="w-[450px] h-[250px] shadow flex justify-center items-center">
                ...
                className="bg-blue-600 text-white font-bold w-[100px] h-[40px] text-[20px] cursor-pointer">-</button>
             ...
             <div className="w-[450px] h-[250px] shadow flex flex-col justify-center items-center">
                 ...
                 <div>
                    <button onClick={()=>{
                        setStatus("Passed")
                    }}className="bg-blue-600 text-white text-center w-[100px] h-[40px] text-[20px] cursor-pointer m-[20px]">Passed</button>
                    <button onClick={()=>{
                        setStatus("Failed")
                    }} 
                    className="bg-blue-600 text-white text-center w-[100px] h-[40px] text-[20px] cursor-pointer">Failed</button>
                  </div>
             </div>
