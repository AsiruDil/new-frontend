                        ...
                        return(
                            <div key={item.productId} className="w-[600px] h-[100px] my-4 rounded-tl-3xl rounded-bl-3xl bg-primary shadow-2xl flex flex-row relative justify-center items-center ">
                                ...
                                <div className="w-[100px] h-full flex flex-row justify-between items-center">
                                     <button className="text-white font-bold rounded-xl hover:bg-secondary  text-4xl cursor-pointer aspect-square bg-accent "><BiMinus/></button>
                                     <h1 className="text-xl text-secondary font-semibold h-full flex items-center ">{item.qty}</h1>
                                     <button className="text-white font-bold rounded-xl hover:bg-secondary  text-4xl  cursor-pointer aspect-square bg-accent"><BiPlus/></button>
                                </div>
                                <div className="w-[200px] h-full flex flex-col justify-center items-end pr-4">
                                 ...
                                 <button className="absolute text-red-600 hover:bg-red-600 hover:text-white rounded-full p-2 right-[-35px] cursor-pointer"><BiTrash/></button>
                            </div>
                        )
                    }
                )
